...
class InstSegNet(nn.Module):
    def __init__(self, n_layers: int, feat_dims: list, n_samples: list, map_feat_dim: int,
        ...
        if self.in_model_loss_model and self.add_intermediat_loss:
            self.intermediate_loss = ComputingGraphLossModel_v4(pos_dim=3, pca_feat_dim=64, in_feat_dim=64, pp_sim_k=16, r=0.03,
    ...
    def forward(
            ...
            loss_selection_dict={},
            loss_model: ComputingGraphLossModel_v2=None
        ):
        '''
        :param pos: poistion matrix with shape bz x N x 3
        :param masks:
        :param inst_seg:
